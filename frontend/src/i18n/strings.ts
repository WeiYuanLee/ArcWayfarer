...
export const STRINGS = {
  ...
  'favorites.transfer.invalid_file': { zh: '檔案格式無法辨識，請選擇 ArcWayfarer 匯出的 JSON 檔。', en: 'Unrecognized file. Choose a JSON file exported by ArcWayfarer.' },
  ...
  'teleport.status.clear_success': { zh: '已送出還原真實定位指令。', en: 'Restore-location command sent.' },
