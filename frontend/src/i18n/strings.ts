...
export const STRINGS = {
  ...
  'routeloop.mode.circle': { zh: '圖案路徑', en: 'Pattern Route' },
  ...
  'routeloop.pattern.position_size': { zh: '位置與大小', en: 'Position & Size' },
  'routeloop.pattern.content': { zh: '圖案內容', en: 'Pattern Content' },
  'routeloop.pattern.quality': { zh: '路徑品質', en: 'Route Quality' },
  'routeloop.pattern.movement': { zh: '移動設定', en: 'Movement' },
  'routeloop.pattern.size': { zh: '圖案大小（公里）', en: 'Pattern Size (km)' },
  'routeloop.pattern.center': { zh: '中心點', en: 'Center Point' },
  'routeloop.pattern.use_current_location': { zh: '帶入當前點', en: 'Use device location' },
  'routeloop.pattern.chinese': { zh: '中文', en: 'Chinese' },
  'routeloop.pattern.text_width': { zh: '文字寬度（公里）', en: 'Text Width (km)' },
  'routeloop.pattern.select': { zh: '選擇圖案', en: 'Choose Pattern' },
  'routeloop.pattern.circle': { zh: '圓形', en: 'Circle' },
  'routeloop.pattern.square': { zh: '方形', en: 'Square' },
  'routeloop.pattern.triangle': { zh: '三角', en: 'Triangle' },
  'routeloop.pattern.heart': { zh: '愛心', en: 'Heart' },
  'routeloop.pattern.infinity': { zh: '無限', en: 'Infinity' },
  'routeloop.pattern.star': { zh: '星形', en: 'Star' },
  'routeloop.pattern.text': { zh: '文字', en: 'Text' },
  'routeloop.pattern.custom_text': { zh: '自訂文字', en: 'Custom Text' },
  'routeloop.pattern.english_letters': { zh: '英文字母', en: 'English letters' },
  'routeloop.pattern.font_regular': { zh: '標準黑體', en: 'Regular Sans' },
  'routeloop.pattern.font_black': { zh: '重黑體', en: 'Black Sans' },
  'routeloop.pattern.rotation': { zh: '旋轉角度', en: 'Rotation' },
  'routeloop.pattern.detail_low': { zh: '低精細', en: 'Low Detail' },
  'routeloop.pattern.detail_standard': { zh: '標準', en: 'Standard' },
  'routeloop.pattern.detail_high': { zh: '高精細', en: 'High Detail' },
  'routeloop.pattern.error.empty': { zh: '請輸入文字。', en: 'Enter text.' },
  'routeloop.pattern.error.emoji': { zh: '此 Emoji 尚未提供可用的向量路徑。', en: 'This emoji does not have a supported vector path yet.' },
  'routeloop.pattern.error.chinese_limit': { zh: '最多可輸入 5 個中文字。', en: 'Use at most 5 Chinese characters.' },
  'routeloop.pattern.error.english_limit': { zh: '最多可輸入 12 個英文字母。', en: 'Use at most 12 English letters.' },
  'routeloop.pattern.error.font_unsupported': { zh: '字型不支援：', en: 'Unsupported by this font: ' },
  'routeloop.pattern.error.no_contours': { zh: '文字沒有可用的路徑輪廓。', en: 'The text has no usable path contours.' },
  'routeloop.pattern.error.generation_failed': { zh: '文字路徑產生失敗。', en: 'Failed to generate the text path.' },
  'routeloop.pattern.error.font_load_failed': { zh: '文字路徑字型載入失敗。', en: 'Failed to load the text font.' },
